      ...
      <div style={{ display: "grid", gridTemplateColumns: hasRemote ? "1fr 1fr" : "1fr", gap: "16px", marginBottom: "24px" }}>
        <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "12px", padding: "16px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "12px" }}>
            ...
            <span style={{ padding: "2px 8px", background: isHost ? "#a855f7" : "#22c55e", color: "#fff", borderRadius: "4px", fontSize: "12px" }}>
              {isHost ? "HOST" : "GUEST"}
            </span>
          </div>
        ...
        {hasRemote ? (
          ...
          <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "12px", padding: "16px" }}>
            <span style={{ color: "#fff", marginBottom: "12px", display: "block" }}>Waiting...</span>
